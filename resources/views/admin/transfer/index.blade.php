            ...
            <tbody>
                @foreach ($table as $data)
                    <tr>
                        ...
                        <a href='{{ url("admin/updateTransfer/$data->id") }}' class="btn btn-info btn-sm">Update</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <script>
        $(document).ready(function(){
            $('.updateBtn').click(function(){
                ...
                $('#atas_nama').val(data[2]);
                $('#id').val(dataId);
                
            });  
        });
        
        $('#editFormTransfer').on('submit',function(e){
            e.preventDefault();
            var id = $('#id').val();

            $.ajax({
                type:'POST',
                url : '/admin/updateTransfer/'+id,
                data:$('#editFormTransfer').serialize(),
